...
const GamePage = () => {
    ...
    const [hiddenHand,] = useState(Array(13).fill("裏")); // 裏向き牌の表示用
    const [discardTiles,] = useState({
        自分: [],
        対面: ["3s"],
        上家: [],
        下家: [],
